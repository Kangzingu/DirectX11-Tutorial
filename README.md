...
2022.8.9.(화)
  ...
  * 기존에는 아예 잘 못 이해하고 있었음. 위키 참고해서 다음과 같이 변경함 rotationMat * localInverseInertiaTensor * rotationMat^T(구현 상에는 연산 편의를 위해 관성텐서의 역행렬로 저장)
```
...
2022.8.14.(일) ~ 2022.8.15.(월)
 - 물리 : 마찰 구현, Convex Collision Detection 수정
