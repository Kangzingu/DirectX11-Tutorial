...
public:
	...
	Matrix4x4(DirectX::XMMATRIX m) :
		m00(DirectX::XMVectorGetX(m.r[0])), m01(DirectX::XMVectorGetX(m.r[1])), m02(DirectX::XMVectorGetX(m.r[2])), m03(DirectX::XMVectorGetX(m.r[3])),
		m10(DirectX::XMVectorGetY(m.r[0])), m11(DirectX::XMVectorGetY(m.r[1])), m12(DirectX::XMVectorGetY(m.r[2])), m13(DirectX::XMVectorGetY(m.r[3])),
		m20(DirectX::XMVectorGetZ(m.r[0])), m21(DirectX::XMVectorGetZ(m.r[1])), m22(DirectX::XMVectorGetZ(m.r[2])), m23(DirectX::XMVectorGetZ(m.r[3])),
		m30(DirectX::XMVectorGetW(m.r[0])), m31(DirectX::XMVectorGetW(m.r[1])), m32(DirectX::XMVectorGetW(m.r[2])), m33(DirectX::XMVectorGetW(m.r[3]))
	{
	}
