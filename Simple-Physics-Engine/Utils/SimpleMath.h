...
public:
	...
	Matrix2x2 Inverse()
	{
		...
		return Matrix2x2(m11, -m01, -m10, m11) * determinantInverse;
	}
	Matrix2x2 operator*(float a)
	{
		return Matrix2x2(m00 * a, m01 * a, m10 * a, m11 * a);
	}
	Matrix2x2& operator*=(float a)
	{
...
public:
	...
	Matrix3x3 Inverse()
	{
		...
		float determinantInverse = 1.0f / Determinant();
		return Matrix3x3(m11 * m22 - m12 * m21, m02 * m21 - m01 * m22, m01 * m12 - m02 * m11, m12 * m20 - m10 * m22, m00 * m22 - m02 * m20, m02 * m10 - m00 * m12, m10 * m21 - m11 * m20, m01 * m20 - m00 * m21, m00 * m11 - m01 * m10) * determinantInverse;
	}
	...
	{
		return Matrix3x3(m00 * a, m01 * a, m02 * a, m10 * a, m11 * a, m12 * a, m20 * a, m21 * a, m22 * a);
	}
	Matrix3x3& operator*=(float a)
	{
...
public:
	...
	{
		Matrix4x4 m;
		m.m00 = 1.0f / (aspectRatio * tan(fovDegree / 2.0f));
		m.m11 = 1.0f / tan(fovDegree / 2.0f);
	...
	static Matrix4x4 SphereInertiaTensor(float mass, float radius)
	{
		Matrix4x4 m;
	...
	static Matrix4x4 EmptySphereInertiaTensor(float mass, float radius)
	{
		Matrix4x4 m;
	...
	{
		return Matrix4x4(m00 + m.m00, m01 + m.m01, m02 + m.m02, m03 + m.m03, m10 + m.m10, m11 + m.m11, m12 + m.m12, m13 + m.m13, m20 + m.m20, m21 + m.m21, m22 + m.m22, m23 + m.m23, m30 + m.m30, m31 + m.m31, m32 + m.m32, m33 + m.m33);
	}
	Matrix4x4& operator+=(Matrix4x4 m)
	{
	...
	{
		return Matrix4x4(m00 + a, m01 + a, m02 + a, m03 + a,
	...
	Matrix4x4 operator-(float a) { 
		return Matrix4x4(m00 - a, m01 - a, m02 - a, m03 - a, m10 - a, m11 - a, m12 - a, m13 - a, m20 - a, m21 - a, m22 - a, m23 - a, m30 - a, m31 - a, m32 - a, m33 - a); }
	Matrix4x4& operator-=(float a)
	{
	...
	Vector3 operator*(Vector3 v)
	{
		return Vector3(m00 * v.x + m01 * v.y + m02 * v.z + m03,
	...
	Matrix4x4 operator=(DirectX::XMMATRIX m)
	{
		return Matrix4x4(m);
	}
	bool operator==(Matrix4x4 m)
	{
		if (m00 == m.m00 && m01 == m.m01 && m02 == m.m02 && m03 == m.m03 &&
			m10 == m.m10 && m11 == m.m11 && m12 == m.m12 && m13 == m.m13 &&
			m20 == m.m20 && m21 == m.m21 && m22 == m.m22 && m23 == m.m23 &&
			m30 == m.m30 && m31 == m.m31 && m32 == m.m32 && m33 == m.m33)
			return true;
	...
	{
		DirectX::XMMATRIX m = DirectX::XMMatrixSet(m00, m10, m20, m30,
												   m01, m11, m21, m31,
												   m02, m12, m22, m32,
												   m03, m13, m23, m33);
		return m;
